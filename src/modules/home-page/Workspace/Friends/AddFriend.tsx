...
export default function AddFriend() {
  ...
  const [
    inviteFriend,
    { isLoading, isError: isSendInviteError, data, error: inviteError },
    ...
    <>
              ...
              <div className='h-[100%] flex-1 flex flex-col bg-[#333c5a]'>
                <div className='w-[100%] flex flex-col justify-start items-start'>
                  <Typography
                    ...
                    variant='h6'>Додати в друзі</Typography>
                  <Typography
      ...
      <div className='flex flex-col items-center justify-center gap-[8px] w-[100%]'>
        ...
        <Typography
          className='text-gray mb-3'
          variant='small'>
          Вампус чекає на друзів. Але вам не обов'язково йому уподібнюватися! </Typography>
      </div>
    </>
  );
}
